  ...
  return (
    <div className="about-page__main-container px-40">
      <div className="h-screen">
        <h1 className="font-bold text-3xl text-teal-500 py-4">About us</h1>
        <h2 className="font-bold text-6xl text-slate-100 pb-5">
          We are wild-hearted creatives who connect people to ideas through the
          almighty power of design.
        </h2>
        <h3 className="text-3xl text-slate-300">
          Based in NW Arkansas, we are a full-service creative agency, where
          form + function is our mantra, your creative brief is our canvas, your
          success is our prize. Let’s go win some hearts and minds for you.
        </h3>
      </div>
      ...
      <div className="h-screen px-48">
        ...
        <p className="text-2xl text-slate-300 text-center py-3">
          We’re a boutique marketing and advertising agency, meaning you’ll get
          all the creative power of a huge agency with the specialized attention
          of a freelancer.
        </p>
        <p className="text-2xl text-slate-300 text-center py-3">
          We flex our teams to fit your project, meaning more creative firepower
          with less overhead while you reap the benefits.
        </p>
      </div>
      ...
      <div className="h-72">
        ...
        <Link
          to="/contact"
          className="border text-slate-100 text-2xl rounded-3xl px-4 py-2 hover:bg-teal-700"
        >
          Contact us
        </Link>
      </div>
