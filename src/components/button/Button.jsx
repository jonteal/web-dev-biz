const Button = ({ children }) => {
  return (
    <a
      href="#_"
      class="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-slate-100 border-2 border-slate-100 rounded-full hover:text-white group hover:bg-gray-50"
    >
